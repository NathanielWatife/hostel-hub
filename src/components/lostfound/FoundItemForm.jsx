...
const FoundItemForm = ({ onSubmit, onCancel }) => {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              className="form-control"
              rows="4"
              placeholder="Detailed description of the item, including condition..."
              required
            />
          </div>
          ...
          <div className="form-group">
            <label className="form-label">Current Custody *</label>
            <input
              type="text"
              name="currentCustody"
              ...
              onChange={handleChange}
              className="form-control"
              placeholder="e.g., My room (Block A, Room 101), Security Office"
              required
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className="form-control"
              placeholder="e.g., Phone number, Room number, Email"
              required
            />
          </div>
          ...
          <div className="form-actions">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <LoadingSpinner size="small" /> : 'Report Found Item'}
            </button>
          </div>
        </form>
      </div>
